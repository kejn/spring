...
public class BookRestService {
    ...
    @RequestMapping(value = "/books-by-library", method = RequestMethod.GET)
    public List<BookTo> findBooksByLibrary(@RequestParam("name") String name) {
    	return bookService.findBooksByLibrary(name);
    }
